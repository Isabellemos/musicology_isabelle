...
Bicep tends to have a  more 'calm' vibe whereas Bodzin plays a bit harder, but both artists have great party music. Therefore, I want to investigate if there are any similarities between these artists, so I can find out if there are specific features which makes me love them. I will do this by analyzing their Spotify API for simmilarities and differences in parameters. 
...
icebowl_2 <- icebowl %>%
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "") + ggtitle("Icebowl by Bicep - chroma SSM")
...
river_2 <- river %>%
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "") + ggtitle("River by Stephan Bodzin - chroma SSM") 
...
The Biceo dendogram shows the same type of smaller clustering.Here, most cluster are even 2 songs. 
...
***
From the research done in this portfolio, I can conclude several things about the similarities between Bodzin’s and Bicep’s music, and got to know more about what I appreciate about these artists. 

First of all, the Valence / Energy measure is very similar in both artist. This makes the atmosphere of their music tend towards ‘angry and turbulent’. 

Another correspondence in both Bicep’s and Bodzin’s music could be seen from their SSM’s. Their music shows a lot of difference within the songs. This is visible in the SSM on timbre and the SSM on chroma. I interpret this variance as a reason that I can keep listening to their songs. 

From the dendrograms was visible that there is not much clustering between the songs of both of both artists, which means that the songs of both artists don’t sound similar. This could be another reason why the music keeps exciting me. 

Only from the key grams I could not find a clear similarity between the artists: the C minor and A minor are significantly prevailing in Biceps music. The G major and A# minor are prevailing in Bodzins music. 
