...
Even though they are in the same genre, these artists have a very different style. Both are one of my favourites, and I can keep listening to them at any moment of day. I have seen both artists live, they play their music live (i.e. not just mixing their music but live performing it) and both times they delivered an amazing rave with everyone dancing. I wonder how this similar feeling can be caused by two artists that play such different music.  

Therefore, I want to investigate if there are any similarities in the music of these artists, so I can find out if there are specific features which makes me love them. I will do this by analyzing the Spotify API for similarities and differences in different parameters. 
