...
For my portfolio, I will be analyzing the songs of two of my alltime favourite artists: the duo Bicep and Stephan Bodzin. 

Both Bicep and Stephan Bodzin are an electronic artists. Their music is in the techno genre. They both have their own characteristic style. One can immediately recognize a song from Bicep or a song from Stephan Bodzin.

Bodzins songs typically are baseline driven, emotive and have a hypnotic synth. Biceps songs often have a shuffling beat, subtle bass and soaring vocals, a surefire way to get any rave absolutely heaving.
...
However these artists have a very different style, they are both one of my favourites, and I can keep listening to them at any moment of day. I have seen both artists live, they play their music live (i.e. not just mixing their music but live performing it) and both times they delivered an amazing rave with everyone dancing.  

I want to investigate if there are any similarities between these artists, so I can find out if there are specific features which makes me love them. I will do this by analyzing their Spotify API for similarities and differences in different parameters. 
